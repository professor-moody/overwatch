...
| [`bundle_engagement`](bundle-engagement.md) | Package all engagement artefacts into a single portable .tar.gz archive. | Audit & reporting | Mutating |
...
| [`generate_report`](generate-report.md) | Generate a comprehensive penetration test report from the engagement graph and activity history. | Audit & reporting | Mutating |
...
| [`run_retrospective`](run-retrospective.md) | Perform a structured post-engagement retrospective analysis. | Audit & reporting | Mutating |
