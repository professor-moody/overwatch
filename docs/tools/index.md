...
| [`withdraw_claim`](withdraw-claim.md) | Durably clear a node or edge's promote_claim judgment, reverting the claim to its DERIVED standing (claim lifecycle Phase 2b). | Graph & data | Mutating |
