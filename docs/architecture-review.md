...
| `get_recovery_status` | WAL/state recovery and active config convergence |
...
| `resolve_config_divergence` | Explicit file/state authority choice using inspected hashes |
