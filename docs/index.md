...
- **[79 MCP tools](tools/index.md)** — State management, action logging, graph queries, BloodHound/AzureHound ingestion, 75 output parsers, persistent interactive sessions, credential playbooks, and pentest report generation. (The live count + set come from `get_system_prompt`.)
...
| | |
|---|---|
| **79** MCP tools | **43** offensive skills |
