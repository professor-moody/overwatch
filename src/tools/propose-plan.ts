...
Valid ops: directive (pause/resume/stop/narrow_scope/skip_types/prioritize a running task), scope (add cidrs/domains/exclusions), approve/deny (a pending action). If the command can't be expressed as these ops, do NOT propose — finish with submit_agent_transcript explaining why.`,
      inputSchema: {
