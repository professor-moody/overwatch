...
const dashboardToolingEndpoints = {
  ...
  getScorecard: endpoint({ operation_id: 'getScorecard', method: 'GET', path: '/api/scorecard', path_schema: EmptyPathSchema, query_schema: EmptyQuerySchema, body_schema: NoBodySchema, responses: { 200: ScorecardDtoSchema }, response_kind: 'json', summary: 'Read the live engagement quality scorecard' }),
  getEvidenceDebt: endpoint({ operation_id: 'getEvidenceDebt', method: 'GET', path: '/api/evidence-debt', path_schema: EmptyPathSchema, query_schema: EmptyQuerySchema, body_schema: NoBodySchema, responses: { 200: EvidenceDebtResponseSchema }, response_kind: 'json', summary: 'Read the ranked evidence-debt queue' }),
  getClaimImpact: endpoint({ operation_id: 'getClaimImpact', method: 'GET', path: '/api/claims/impact', path_schema: EmptyPathSchema, query_schema: ClaimImpactQuerySchema, body_schema: NoBodySchema, responses: { 200: ClaimImpactResponseSchema }, response_kind: 'json', summary: 'Read a claim editor impact snapshot' }),
  ...
  promoteClaim: endpoint({ operation_id: 'promoteClaim', method: 'POST', path: '/api/claims/promote', path_schema: EmptyPathSchema, query_schema: EmptyQuerySchema, body_schema: ClaimPromoteRequestSchema, responses: { 200: ClaimPromoteResultSchema }, response_kind: 'json', summary: 'Promote a claim standing' }),
  withdrawClaim: endpoint({ operation_id: 'withdrawClaim', method: 'POST', path: '/api/claims/withdraw', path_schema: EmptyPathSchema, query_schema: EmptyQuerySchema, body_schema: ClaimWithdrawRequestSchema, responses: { 200: ClaimWithdrawResultSchema }, response_kind: 'json', summary: 'Withdraw a claim promotion' }),
