...
const dashboardPlaybookLifecycleEndpoints = {
  startPlaybookStep: endpoint({ operation_id: 'startPlaybookStep', method: 'POST', path: '/api/playbook-runs/{run_id}/steps/{step_id}/start', path_schema: PlaybookStepPathSchema, query_schema: EmptyQuerySchema, body_schema: z.union([NoBodySchema, EmptyBodySchema]), responses: { 200: PlaybookStepClaimResponseSchema, 400: DashboardErrorSchema, 404: DashboardErrorSchema, 409: DashboardErrorSchema }, response_kind: 'json', summary: 'Claim one ready playbook step' }),
  resumePlaybookRun: endpoint({ operation_id: 'resumePlaybookRun', method: 'POST', path: '/api/playbook-runs/{run_id}/resume', path_schema: idPath('run_id'), query_schema: EmptyQuerySchema, body_schema: z.union([NoBodySchema, EmptyBodySchema]), responses: { 200: PlaybookRunResponseSchema, 400: DashboardErrorSchema, 404: DashboardErrorSchema, 409: DashboardErrorSchema }, response_kind: 'json', summary: 'Resume an interrupted playbook run' }),
  retryPlaybookStep: endpoint({ operation_id: 'retryPlaybookStep', method: 'POST', path: '/api/playbook-runs/{run_id}/steps/{step_id}/retry', path_schema: PlaybookStepPathSchema, query_schema: EmptyQuerySchema, body_schema: z.union([NoBodySchema, EmptyBodySchema]), responses: { 200: PlaybookStepClaimResponseSchema, 400: DashboardErrorSchema, 404: DashboardErrorSchema, 409: DashboardErrorSchema }, response_kind: 'json', summary: 'Append a retry attempt for a playbook step' }),
  skipPlaybookStep: endpoint({ operation_id: 'skipPlaybookStep', method: 'POST', path: '/api/playbook-runs/{run_id}/steps/{step_id}/skip', path_schema: PlaybookStepPathSchema, query_schema: EmptyQuerySchema, body_schema: PlaybookSkipRequestSchema, responses: { 200: PlaybookRunResponseSchema, 400: DashboardErrorSchema, 404: DashboardErrorSchema, 409: DashboardErrorSchema }, response_kind: 'json', summary: 'Skip a playbook step' }),
  interruptPlaybookAttempt: endpoint({ operation_id: 'interruptPlaybookAttempt', method: 'POST', path: '/api/playbook-runs/{run_id}/steps/{step_id}/interrupt', path_schema: PlaybookStepPathSchema, query_schema: EmptyQuerySchema, body_schema: PlaybookSkipRequestSchema, responses: { 200: PlaybookRunResponseSchema, 400: DashboardErrorSchema, 404: DashboardErrorSchema, 409: DashboardErrorSchema }, response_kind: 'json', summary: 'Release an active playbook attempt as interrupted' }),
} as const;
